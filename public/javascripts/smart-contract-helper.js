...
var auctionContractAddress = "0x076c38101F4fD272C376339a51DDB771cf8f49DA";
...
function sendAuction(auctionContractAddress, callback) {
    var contractAbi = localWeb3.eth.contract(auctionContractAbi);
    var myContract = contractAbi.at(auctionContractAddress);
    ...
    myContract.auctionSend.sendTransaction(transactionObject, function (error, result) {
            if (error) {
                console.log('something wrong');
                return;
            }
...
function issueAuction(auctionContractAddress, callback) {
    var contractAbi = localWeb3.eth.contract(auctionContractAbi);
    var myContract = contractAbi.at(auctionContractAddress);
    ...
    myContract.auctionIssue.sendTransaction(transactionObject, function (error, result) {
            if (error) {
                console.log('something wrong');
                return;
            }
